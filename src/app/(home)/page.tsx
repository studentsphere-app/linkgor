...
export default function HomePage() {
	...
	const installCommands = {
		pnpm: "pnpm add @studentsphere/linkgor",
		npm: "npm install @studentsphere/linkgor",
		yarn: "yarn add @studentsphere/linkgor",
		bun: "bun add @studentsphere/linkgor",
	};

	const codeSnippets: Record<Tab, string> = {
		quickstart: `import { loginWithCredentials, getPlanning, getProfile } from 'linkgor';
 
async function run() {
  // 1. Authenticate with Wigor CAS
...
run();`,
		auth: `import { loginWithCredentials } from 'linkgor';
 
// Authenticate and retrieve a Wigor session
...
console.log('Session token:', session.token);`,
		planning: `import { getPlanning } from 'linkgor';
			...
			<div className="flex-1 flex flex-col justify-center items-center px-6 pt-24 pb-16 text-center relative z-10">
				<div className="max-w-(--fd-layout-width) w-full">
					...
					<h1 className="text-4xl sm:text-5xl md:text-7xl font-medium tracking-tight text-fd-foreground mb-6 max-w-3xl mx-auto leading-[1.1]">
						...
						<span className="text-fd-primary">Wigor Services</span>
					</h1>
					...
					<div className="flex flex-wrap justify-center gap-3.5 mb-12">
						...
						<a
							href="https://github.com/studentsphere-app/linkgor"
							target="_blank"
							rel="noopener noreferrer"
