...
description: Fetch and parse student profile attributes from Wigor Services
---

`linkgor` allows you to retrieve student metadata (such as campus location, email address, and full name) from the Central Authentication Service (CAS) attributes.
