...
description: Legal information and responsible use policy for linkgor
---

This page contains the legal disclaimers, responsibilities, and code interoperability statements regarding the use of the `@studentsphere/linkgor` package.
...
It performs only what is strictly necessary to make the Wigor schedule and profile services work together with other client tools (such as third-party calendar synchronizers). It does not copy, share, or alter the original software's binary code. The analysis is strictly limited to facilitating client-side interoperability.

## Contact

For any legal questions, concerns, or requests regarding this project, please send an email to:
[contact@studentsphere.app](mailto:contact@studentsphere.app?subject=%5BStudentSphere%5D%20Legal%20Inquiry%20about%20Linkgor)
