# Contributing to linkgor

Thank you for your interest in contributing to **linkgor**! We welcome contributions of all forms, including bug reports, feature requests, documentation improvements, and code changes.
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/studentsphere-app/linkgor.git
   cd linkgor
   ```
